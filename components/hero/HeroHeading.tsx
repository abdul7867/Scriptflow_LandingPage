        ...
        <div className="w-full">
            ...
            */}
            <motion.p 
                ...
                className="mt-6 md:mt-8 text-lg md:text-xl lg:text-2xl text-zinc-400 font-light leading-relaxed max-w-2xl"
            >
                The first AI that watches viral reels and reverse-engineers them to write your unique, high-performing scripts in seconds.
            </motion.p>
        </div>
    );
}
